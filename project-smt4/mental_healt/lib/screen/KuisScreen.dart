...
class KuisScreen extends StatelessWidget {
  ...
  Widget _buildInfoPoint(BuildContext context, IconData icon, String text) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: Theme.of(context).primaryColor.withOpacity(0.8), size: 20),
  ...
  Widget build(BuildContext context) {
    ...
    final String? testTypeArg = ModalRoute.of(context)?.settings.arguments as String?;
    ...
    return Scaffold(
      ...
      body: ListView( // Ganti Column dengan ListView agar bisa scroll jika konten banyak
        ...
        children: [
          ...
          _buildInfoPoint(context, Icons.timer_outlined, 'Perkiraan Waktu: $estimatedTime'),
          _buildInfoPoint(context, Icons.privacy_tip_outlined, 'Jawaban Anda akan dijaga kerahasiaannya.'),
